...
#       return 5
 ...
 private string DescribeHPGLPerimeter(PointCollection Perimetro, string PenUp, string PenDown, double UnitConversion = 1, char LF = '\n')
        {
            var HpglStr = "";
            ...
            HpglStr += PenDown + (int)(Perimetro[0].X / UnitConversion) + "," + (int)(Perimetro[0].Y / UnitConversion) + ";" + LF;
            HpglStr += PenUp + ";" + LF;
            return HpglStr;
        }
